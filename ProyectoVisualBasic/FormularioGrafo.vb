...
Public Class FormularioGrafo
    ...
    Private Sub FormularioGrafo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub grafo1ToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles grafo1ToolStripMenuItem3.Click
        Dim hiMoa As MatrizAdyacente = New MatrizAdyacente(nodos)
        hiMoa.Show()
    End Sub
